...
Date: 2025-10-23
Description: Python script to transform i2b2 raw data into data required for type-2 diabetes prediction model.
Version: 1.0

TO-DO:
1. Add units validator function in helper functions
...
parse = argparse.ArgumentParser(description = '''This script is for transforming raw i2b2 data into dataset that can be used for model prediction
...
class script_config:
    ...
    cohort_file = data_folder + i2b2_config.patient_file
    lab_file = data_folder + i2b2_config.labresults_file
    diag_file = data_folder + i2b2_config.diag_file
    med_file = data_folder + i2b2_config.med_file
    bmi_bp_file = data_folder + i2b2_config.bmi_and_bp_file
    cvs_file = data_folder + i2b2_config.cvs_file
...
if __name__ == '__main__':
    ...
    target_lab_results_columns = i2b2_config.target_lab_results_columns
    target_diag_columns = i2b2_config.target_diag_columns
    ...
    act_list_to_drop = [get_active_ingredient(rxcui) for rxcui in i2b2_config.ignore_rxnorm_codes]
